...
```
See [OffloadingManager/requirements.txt](../requirements.txt)
...
./autostart_om.sh
```
Files: [OffloadingManager/main.py](../main.py), [OffloadingManager/config.json](../config.json), [OffloadingManager/autostart_om.sh](../autostart_om.sh)

## Configuration

### Configuration File ([OffloadingManager/config.json](../config.json))
...
### Algorithm Configuration ([OffloadingManager/algorithm.py](../algorithm.py))
...
1. **OM Server** ([OffloadingManager/om_server.py](../om_server.py)): TCP server handling Bridge CP connections
2. **Decision Engine** ([OffloadingManager/decision_engine.py](../decision_engine.py)): Resource allocation funcstions that algorithm calls
3. **Algorithm** ([OffloadingManager/algorithm.py](../algorithm.py)): Pluggable decision-making algorithm
4. **Discovery Client** ([OffloadingManager/discovery_client.py](../discovery_client.py)): Interface to Discovery Service
5. **Config Manager** ([OffloadingManager/config_manager.py](../config_manager.py)): Global configuration handling
6. **Logger** ([OffloadingManager/logger_config.py](../logger_config.py)): Structured logging system
7. **External data source handler** ([OffloadingManager/external_data_sources.py](../external_data_sources.py)): Module for fetching data over HTTP using request - response mechanism. Can be configured to automatically refresh data periodically.
### Message Flow
```
