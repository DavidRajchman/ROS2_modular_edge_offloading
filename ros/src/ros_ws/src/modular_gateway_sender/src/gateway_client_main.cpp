...
int main(int argc, char * argv[])
{
  ...
  gateway::MessageHandlerBase::configure_handler_mode(string_handler, gateway::HandlerMode::SUBSCRIBER_ONLY);
  ...
  gateway::MessageHandlerBase::configure_handler_mode(laser_handler, gateway::HandlerMode::SUBSCRIBER_ONLY);
