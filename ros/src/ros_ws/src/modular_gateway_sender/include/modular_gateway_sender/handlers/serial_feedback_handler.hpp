#ifndef SERIAL_FEEDBACK_HANDLER_HPP
#define SERIAL_FEEDBACK_HANDLER_HPP
...
class SerialFeedbackHandler : public MessageHandlerBase {
public:
  SerialFeedbackHandler(RosGateway* gateway, rclcpp::Node::SharedPtr node);
...
#endif // SERIAL_FEEDBACK_HANDLER_HPP
